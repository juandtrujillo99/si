<div class="row">
    ...
    <div align="center" class="col-10 col-md-12 bg-image" style="background-image: url(<?php echo RUTA_IMG_OPTIMIZADA;?>fondo/22.webp);border-radius: 0px 0px 1em 1em;">
        <div class="valign-wrapper row">
            <div class="d-none d-sm-block" style="height: 50vh;"></div>
            <div class="d-block d-sm-none" style="height: 30vh;"></div>
            <div align="center" class="col-12">
                <p class="textoBold white-text d-none d-sm-block" style="font-size: 2.5em;">Panel de administración</p>
            </div>            
        </div>
    </div>  
    <div class="col-1 d-block d-sm-none"></div>
    ...
    <div class="col-10 col-md-4 row" align="center">
        ...
        <div id="actualizar" class="modal bottom-sheet col-12 col-md-12" style="max-height: 100%;">    
            ...
            <div style="padding: 3em 0;">
                <p class="textoBold textoSubtitulo">Configuración de tu foto de perfil</p>
            </div>
            <div>
