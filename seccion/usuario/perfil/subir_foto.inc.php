...
if(isset($_POST['guardar_imagen']) && !empty($_FILES['archivo_subido']['tmp_name'])) {
	...
	if ($tipo_imagen != "jpg" && $tipo_imagen != "png" && $tipo_imagen != "jpeg" && $tipo_imagen != "gif") {
		...
		DIRECTORIO_RAIZ."/assets/fotos-perfil/usuario/".$usuario->obtener_email()."foto")) {
			?>
			<div class="row desaparecer-automaticamente section center-align valign-wrapper" style="position: fixed;z-index: 1000;width: 100%;">
				<div class="col-2 col-md-4"></div>
				<div class="col-8 col-md-4">
					<div class="card">
						<div class="card-image">
				            ...
				            <div align="center" style="padding:2em 0;">   
				                <div class="img-profile bg-cover" style="background-image:url(<?php echo SERVIDOR.'/assets/fotos-perfil/usuario/'.$usuario->obtener_email()."foto"; ?>);"></div>
				            </div>
...
if (isset($_POST['borrar']) && file_exists(DIRECTORIO_RAIZ."/assets/fotos-perfil/usuario/".$usuario->obtener_email()."foto")) {	
	@unlink(DIRECTORIO_RAIZ."/assets/fotos-perfil/usuario/".$usuario->obtener_email()."foto");
	return;//Si le dan al boton (borrar) y ademas, el archivo existe, borra el archivo de la carpeta
}elseif (isset($_POST['borrar']) && !file_exists(DIRECTORIO_RAIZ."/assets/fotos-perfil/usuario/".$usuario->obtener_email()."foto")) {
