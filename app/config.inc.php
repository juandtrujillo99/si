...
//info de la base de datos
    ...
    define('PASSWORD', '');
    define('NOMBRE_BD', 'si');//Nombre de la Base de datos
...
//Pestañas principales (basicas o  comunes) de la web
	...
	*/
	define("SERVIDOR", "http://localhost/si");//carpeta raiz (la que contiene todos los archivos para el funcionamiento de la página)
