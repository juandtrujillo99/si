...
class ValidadorEntradaEditadaTienda extends ValidadorTienda {
	...
	public function __construct($titulo, $titulo_original, $url, $url_original, $imagen, $imagen_original, $url_externa, $url_externa_original, $precio, $precio_original, $texto,
